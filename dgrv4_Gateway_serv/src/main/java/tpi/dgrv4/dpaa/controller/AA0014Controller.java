...
import tpi.dgrv4.dpaa.service.AA0014Service;
 ...
 */
@RestController
public class AA0014Controller {
		
	@Autowired
	private AA0014Service service;
	 ...
	 */
	@CrossOrigin
	@PostMapping(value = "/dgrv4/11/AA0014", //
		consumes = MediaType.APPLICATION_JSON_VALUE, //
		produces = MediaType.APPLICATION_JSON_VALUE)
	public TsmpBaseResp<AA0014Resp> deleteTRole (@RequestHeader HttpHeaders headers //
			, @RequestBody TsmpBaseReq<AA0014Req> req, HttpServletRequest httpReq) {
		TsmpHttpHeader tsmpHttpHeader = ControllerUtil.toTsmpHttpHeader(headers);
		AA0014Resp resp = null;
		...
		try {
			...
			resp = service.deleteTRole(auth, req.getBody(), iip);
		} catch (Exception e) {
