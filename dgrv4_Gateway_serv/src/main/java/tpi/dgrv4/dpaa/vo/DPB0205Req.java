...
public class DPB0205Req extends ReqValidator {
	/** ID, YYYYMMDD格式 EX: 20230425_b52f599d */
	private String id;
	...
	public String toString() {
		return "DPB0205Req [id=" + id + ", clientId=" + clientId + ", status=" + status + ", remark=" + remark
				+ ", connectionName=" + connectionName + ", sqlPtmt=" + sqlPtmt + ", sqlParams=" + sqlParams
				+ ", userMimaAlg=" + userMimaAlg + ", userMimaColName=" + userMimaColName + ", idtSub=" + idtSub
				+ ", idtName=" + idtName + ", idtEmail=" + idtEmail + ", idtPicture=" + idtPicture + ", iconFile="
				+ iconFile + ", pageTitle=" + pageTitle + "]";
	}
