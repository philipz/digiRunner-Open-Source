...
public class DPB0181Req extends ReqValidator{
	...
	private List<DPB0181LdapDataItem> ldapDataList;
	...
	public List<DPB0181LdapDataItem> getLdapDataList() {
		return ldapDataList;
	}
	public void setLdapDataList(List<DPB0181LdapDataItem> ldapDataList) {
