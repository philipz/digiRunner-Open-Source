...
public class DPB0090RespItem {
	...
	/** [查詢] 按鈕是否顯示 每個case 都 = true */
	private String queryVisiable;

	/** [異動申請] 按鈕是否顯示 Open Api Key 狀態為啟用= true */
	private String updateVisiable;

	/** [撤銷申請] 按鈕是否顯示 Open Api Key 狀態為啟用= true */
	private String revokeVisiable;
	...
	public String getQueryVisiable() {
		return queryVisiable;
	}

	public void setQueryVisiable(String queryVisiable) {
		this.queryVisiable = queryVisiable;
	}
	...
	public String getRevokeVisiable() {
		return revokeVisiable;
	}

	public void setRevokeVisiable(String revokeVisiable) {
		this.revokeVisiable = revokeVisiable;
	}
