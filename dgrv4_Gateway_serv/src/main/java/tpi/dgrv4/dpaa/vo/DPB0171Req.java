...
public class DPB0171Req extends ReqValidator {
	...
	public String toString() {
		return "DPB0171Req [clientId=" + clientId + ", idpType=" + idpType + ", status=" + status + ", remark=" + remark
				+ ", idpClientId=" + idpClientId + ", idpClientMima=" + idpClientMima + ", idpClientName="
				+ idpClientName + ", wellKnownUrl=" + wellKnownUrl + ", callbackUrl=" + callbackUrl + ", authUrl="
				+ authUrl + ", accessTokenUrl=" + accessTokenUrl + ", scope=" + scope + ", getClass()=" + getClass()
