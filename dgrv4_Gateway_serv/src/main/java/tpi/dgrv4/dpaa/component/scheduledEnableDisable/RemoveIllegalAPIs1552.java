...
@Component
public class RemoveIllegalAPIs1552 extends Handler implements ApiPublicFlagHandlerInterface {
	...
	public ApiListAndAlgorithmClassifier handle(ApiPublicFlagHandlerData data, ApiListAndAlgorithmClassifier classifier,
		...
		if (TsmpDpItem.isEqualParam1(TsmpDpItem.ENABLE_FLAG_DEACTIVATE, apiStatus) && apiEnableScheduledDate == 0) {

			throw TsmpDpAaRtnCode._1552.throwing();
...
//			return classifier;
	...
	public List<AA0303Item> getAA0303ItemRespList(List<TsmpApi> apis, String locale) {
		...
		for (TsmpApi api : apis) {
			...
			resp.setErrMsg(getErrMsg(TsmpDpAaRtnCode._1552, locale));
