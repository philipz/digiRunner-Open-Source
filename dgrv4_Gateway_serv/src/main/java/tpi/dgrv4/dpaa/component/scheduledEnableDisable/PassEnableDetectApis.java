...
@Component
public class PassEnableDetectApis extends Handler implements ApiPublicFlagHandlerInterface {
	...
	public ApiListAndAlgorithmClassifier handle(ApiPublicFlagHandlerData data, ApiListAndAlgorithmClassifier classifier,
		...
		classifier.setAlgorithm( //
				(tsmpApi) -> getEnableAlgorithm()//
						.getScheduledEnableAlgorithm(tsmpApi, enableScheduledDate));
