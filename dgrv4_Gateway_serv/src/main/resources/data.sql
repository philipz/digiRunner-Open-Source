...
INSERT INTO TSMP_DP_ITEMS (ITEM_ID, ITEM_NO, ITEM_NAME, SUBITEM_NO, SUBITEM_NAME, SORT_BY, IS_DEFAULT, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5, LOCALE) VALUES (13, 'REVIEW_STATUS', '簽核狀態', 'END', '結案/終止', 55, NULL, NULL, NULL, NULL, NULL, NULL, 'zh-TW');
INSERT INTO TSMP_DP_ITEMS (ITEM_ID, ITEM_NO, ITEM_NAME, SUBITEM_NO, SUBITEM_NAME, SORT_BY, LOCALE, IS_DEFAULT, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5) VALUES (13, 'REVIEW_STATUS', 'Sign-off status', 'END', 'Case closed/terminated', 55, 'en-US', NULL, NULL, NULL, NULL, NULL, NULL);
