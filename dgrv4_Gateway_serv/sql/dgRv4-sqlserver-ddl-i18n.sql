...
CREATE TABLE DGR_AUDIT_LOGD (
	...
	PARAM1 nvarchar(4000)  NULL,
	PARAM2 nvarchar(4000)  NULL,
	PARAM3 nvarchar(4000)  NULL,
	PARAM4 nvarchar(4000)  NULL,
	PARAM5 nvarchar(4000)  NULL,
	STACK_TRACE nvarchar(4000)  NULL,
	CREATE_DATE_TIME datetime DEFAULT getdate() NULL,
	CREATE_USER NVARCHAR(1000)  DEFAULT 'SYSTEM' NULL,
...
CREATE TABLE DGR_AUDIT_LOGM (
	...
	ORIG_API_URL nvarchar(500)  NULL,
...
CREATE TABLE DGR_NODE_LOST_CONTACT (
	...
	PORT int NOT NULL,
	LOST_TIME nvarchar(100)  NOT NULL,
...
CREATE TABLE OAUTH_CLIENT_DETAILS (
	...
	CLIENT_SECRET nvarchar(255)  DEFAULT NULL NULL,
	[SCOPE] nvarchar(2048)  DEFAULT NULL NULL,
	AUTHORIZED_GRANT_TYPES nvarchar(255)  DEFAULT NULL NULL,
	WEB_SERVER_REDIRECT_URI nvarchar(255)  DEFAULT NULL NULL,
	...
	AUTOAPPROVE nvarchar(255)  DEFAULT NULL NULL,
...
CREATE TABLE TSMPN_API_MODULE (
	...
	MODULE_VERSION nvarchar(255)  NOT NULL,
	MODULE_APP_CLASS nvarchar(255)  NOT NULL,
	MODULE_BYTES varbinary(MAX) NOT NULL,
	MODULE_MD5 nvarchar(255)  NOT NULL,
	MODULE_TYPE nvarchar(255)  NOT NULL,
	UPLOAD_TIME datetime NOT NULL,
	UPLOADER_NAME nvarchar(255)  NOT NULL,
	STATUS_TIME datetime NULL,
	STATUS_USER nvarchar(255)  NULL,
	ACTIVE bit NOT NULL,
	NODE_TASK_ID bigint NULL,
	ORG_ID varchar(255)  DEFAULT NULL NULL,
	TARGET_VERSION varchar(30)  DEFAULT NULL NULL,
...
CREATE TABLE TSMPN_NODE_TASK (
	ID bigint NOT NULL,
	TASK_SIGNATURE nvarchar(255)  NOT NULL,
	TASK_ID nvarchar(255)  NOT NULL,
	TASK_ARG nvarchar(4000)  NULL,
	COORDINATION nvarchar(255)  NOT NULL,
	EXECUTE_TIME datetime NOT NULL,
	NOTICE_NODE nvarchar(255)  NOT NULL,
...
CREATE TABLE TSMPN_SITE (
	...
	BINDING_IP nvarchar(20)  NOT NULL,
	BINDING_PORT int NOT NULL,
	APP_POOL nvarchar(255)  NOT NULL,
	ROOT_PATH nvarchar(MAX)  NULL,
	CLR_VERSION nvarchar(30)  NULL,
...
CREATE TABLE TSMP_ALERT (
	...
	IM_TYPE nvarchar(20)  NULL,
	IM_ID nvarchar(100)  NULL,
	EX_TYPE char(1)  NOT NULL,
	EX_DAYS nvarchar(100)  NULL,
	EX_TIME nvarchar(100)  NULL,
	ALERT_DESC nvarchar(200)  NULL,
	ALERT_SYS nvarchar(20)  DEFAULT NULL NULL,
	ALERT_MSG nvarchar(300)  DEFAULT NULL NULL,
	CREATE_TIME datetime NULL,
	UPDATE_TIME datetime NULL,
	CREATE_USER NVARCHAR(1000)  DEFAULT NULL NULL,
	UPDATE_USER NVARCHAR(1000)  DEFAULT NULL NULL,
	ES_SEARCH_PAYLOAD nvarchar(1024)  DEFAULT NULL NULL,
	MODULENAME nvarchar(255)  NULL,
	RESPONSETIME nvarchar(255)  NULL,
...
CREATE TABLE TSMP_ALERT_LOG (
	...
	ALERT_MSG nvarchar(300)  DEFAULT '' NOT NULL,
...
CREATE TABLE TSMP_API (
	...
	API_DESC nvarchar(1500)  NULL,
	CREATE_TIME datetime NOT NULL,
	UPDATE_TIME datetime NULL,
	CREATE_USER NVARCHAR(1000)  NULL,
	UPDATE_USER NVARCHAR(1000)  NULL,
	API_OWNER nvarchar(100)  DEFAULT NULL NULL,
	ORG_ID varchar(255)  DEFAULT NULL NULL,
	PUBLIC_FLAG char(1)  DEFAULT NULL NULL,
	SRC_URL nvarchar(2000)  DEFAULT NULL NULL,
	API_UID varchar(36)  NULL,
	DATA_FORMAT char(1)  DEFAULT NULL NULL,
	JWE_FLAG varchar(1)  DEFAULT NULL NULL,
	JWE_FLAG_RESP varchar(1)  NULL,
	API_CACHE_FLAG char(1)  DEFAULT '1' NOT NULL,
	MOCK_STATUS_CODE CHAR(3)  NULL,
	MOCK_HEADERS NVARCHAR(2000)  NULL,
	MOCK_BODY nvarchar(2000)  NULL,
...
CREATE TABLE TSMP_API_IMP (
	...
	API_NAME nvarchar(255)  NULL,
	API_DESC NVARCHAR(300)  NULL,
	API_OWNER nvarchar(100)  NULL,
	URL_RID char(1)  DEFAULT '0' NULL,
	API_SRC char(1)  DEFAULT 'M' NULL,
	SRC_URL NVARCHAR(2000)  NULL,
	API_UUID varchar(64)  NULL,
	PATH_OF_JSON nvarchar(255)  NOT NULL,
	METHOD_OF_JSON nvarchar(50)  NOT NULL,
	PARAMS_OF_JSON nvarchar(255)  NULL,
	HEADERS_OF_JSON nvarchar(255)  NULL,
	CONSUMES_OF_JSON nvarchar(100)  NULL,
	PRODUCES_OF_JSON nvarchar(255)  NULL,
...
CREATE TABLE TSMP_API_MODULE (
	...
	ACTIVE bit NOT NULL,
	NODE_TASK_ID bigint NULL,
	V2_FLAG char(1)  DEFAULT NULL NULL,
	ORG_ID varchar(255)  DEFAULT NULL NULL,
...
CREATE TABLE TSMP_API_REG (
	...
	SRC_URL nvarchar(2000)  NOT NULL,
	REG_STATUS char(1)  NOT NULL,
	API_UUID nvarchar(64)  NULL,
	PATH_OF_JSON nvarchar(255)  NULL,
	METHOD_OF_JSON nvarchar(50)  NOT NULL,
	PARAMS_OF_JSON nvarchar(255)  NULL,
	HEADERS_OF_JSON nvarchar(255)  NULL,
	CONSUMES_OF_JSON nvarchar(100)  NULL,
...
CREATE TABLE tsmp_client (
	...
	TPS int NOT NULL,
	EMAILS nvarchar(500)  DEFAULT NULL NULL,
	...
	CLIENT_ALIAS NVARCHAR(150)  DEFAULT NULL NULL,
	SECURITY_LEVEL_ID varchar(10)  DEFAULT 'SYSTEM' NULL,
	SIGNUP_NUM varchar(100)  DEFAULT NULL NULL,
...
CREATE TABLE TSMP_CLIENT_LOG (
	...
	AGENT nvarchar(500)  NOT NULL,
	EVENT_TYPE nvarchar(10)  NOT NULL,
	EVENT_MSG nvarchar(300)  NOT NULL,
...
CREATE TABLE TSMP_DP_ABOUT (
	...
	ABOUT_SUBJECT nvarchar(100)  NOT NULL,
...
CREATE TABLE TSMP_DP_API_AUTH2 (
	...
	APPLY_PURPOSE nvarchar(3000)  NOT NULL,
	REF_REVIEW_USER nvarchar(255)  NULL,
	REVIEW_REMARK NVARCHAR(3000)  NULL,
	CREATE_DATE_TIME datetime DEFAULT getdate() NULL,
	CREATE_USER NVARCHAR(1000)  DEFAULT 'SYSTEM' NULL,
	UPDATE_DATE_TIME datetime NULL,
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(MAX)  NULL,
...
CREATE TABLE TSMP_DP_APP (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(100)  NULL,
...
CREATE TABLE TSMP_DP_APPT_JOB (
	...
	IN_PARAMS nvarchar(4000)  NULL,
	EXEC_RESULT varchar(4000)  NULL,
	EXEC_OWNER varchar(20)  DEFAULT 'SYS' NULL,
	STACK_TRACE nvarchar(4000)  NULL,
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	IDENTIF_DATA nvarchar(4000)  NULL,
	PERIOD_UID varchar(36)  DEFAULT newid() NOT NULL,
...
CREATE TABLE TSMP_DP_APPT_RJOB (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH NVARCHAR(396)  NULL,
...
CREATE TABLE TSMP_DP_APPT_RJOB_D (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH NVARCHAR(186)  NULL,
...
CREATE TABLE TSMP_DP_APP_CATEGORY (
	...
	APP_CATE_NAME nvarchar(100)  NOT NULL,
	DATA_SORT int NULL,
	ORG_ID varchar(255)  NULL,
	CREATE_TIME datetime DEFAULT getdate() NULL,
	CREATE_USER NVARCHAR(1000)  DEFAULT 'SYSTEM' NULL,
...
CREATE TABLE TSMP_DP_CALLAPI (
	...
	REQ_MSG nvarchar(4000)  NULL,
	RESP_MSG nvarchar(4000)  NULL,
	TOKEN_URL nvarchar(500)  NULL,
	SIGN_CODE_URL nvarchar(500)  NULL,
...
CREATE TABLE TSMP_DP_CLIENTEXT (
	...
	CONTENT_TXT nvarchar(1000)  NOT NULL,
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(4000)  NULL,
...
CREATE TABLE TSMP_DP_FAQ_ANSWER (
	...
	ANSWER_NAME nvarchar(4000)  NOT NULL,
	ANSWER_NAME_EN nvarchar(4000)  NULL,
...
CREATE TABLE TSMP_DP_FAQ_QUESTION (
	...
	QUESTION_NAME nvarchar(4000)  NOT NULL,
	QUESTION_NAME_EN nvarchar(4000)  NULL,
	DATA_SORT int NULL,
...
CREATE TABLE TSMP_DP_FILE (
	...
	REF_FILE_CATE_CODE nvarchar(50)  NOT NULL,
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(400)  NULL,
	IS_BLOB varchar(1)  DEFAULT 'N' NULL,
	IS_TMPFILE varchar(1)  DEFAULT 'N' NULL,
...
CREATE TABLE TSMP_DP_ITEMS (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(200)  NULL,
...
CREATE TABLE TSMP_DP_MAIL_TPLT (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(2120)  NULL,
...
CREATE TABLE TSMP_DP_NEWS (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH NVARCHAR(2148)  NULL,
...
CREATE TABLE TSMP_DP_REQ_ORDERM (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH nvarchar(1020)  NULL,
...
CREATE TABLE TSMP_FUNC (
	...
	FUNC_NAME_EN nvarchar(50)  DEFAULT NULL NULL,
	FUNC_DESC nvarchar(300)  DEFAULT NULL NULL,
	LOCALE nvarchar(10)  NOT NULL,
	UPDATE_USER NVARCHAR(1000)  NULL,
	UPDATE_TIME datetime NOT NULL,
	FUNC_URL nvarchar(300)  DEFAULT NULL NULL,
...
CREATE TABLE TSMP_FUNC_EDITION (
	...
	FUNC_DESC nvarchar(300)  DEFAULT NULL NULL,
	FUNC_URL nvarchar(300)  DEFAULT NULL NULL,
	LOCALE nvarchar(10)  DEFAULT 'zh-TW' NOT NULL,
...
CREATE TABLE TSMP_GROUP (
	...
	CREATE_USER NVARCHAR(1000)  NULL,
	UPDATE_USER NVARCHAR(1000)  NULL,
	GROUP_ALIAS NVARCHAR(150)  DEFAULT NULL NULL,
	GROUP_DESC NVARCHAR(1500)  DEFAULT NULL NULL,
	GROUP_ACCESS varchar(255)  DEFAULT NULL NULL,
	SECURITY_LEVEL_ID varchar(10)  DEFAULT 'SYSTEM' NULL,
...
CREATE TABLE TSMP_GROUP_AUTHORITIES (
	...
	GROUP_AUTHORITIE_DESC NVARCHAR(60)  NULL,
...
CREATE TABLE TSMP_REG_HOST (
	...
	REGHOST_STATUS char(1)  NOT NULL,
...
CREATE TABLE TSMP_ROLE_TXID_MAP (
	...
	UPDATE_USER NVARCHAR(1000)  NULL,
	VERSION int DEFAULT 1 NULL,
	KEYWORD_SEARCH NVARCHAR(20)  NULL,
...
CREATE TABLE TSMP_RTN_CODE (
	TSMP_RTN_CODE nvarchar(20)  NOT NULL,
	LOCALE nvarchar(10)  NOT NULL,
	TSMP_RTN_MSG nvarchar(300)  NOT NULL,
	TSMP_RTN_DESC nvarchar(300)  NULL,
...
CREATE TABLE TSMP_SECURITY_LEVEL (
	...
	SECURITY_LEVEL_DESC NVARCHAR(60)  NULL,
...
CREATE TABLE TSMP_SESSION (
	API_SESSION_ID nvarchar(100)  NOT NULL,
	CUST_ID nvarchar(30)  NULL,
	CUST_NAME nvarchar(20)  NULL,
	CONST_DATA nvarchar(1000)  NOT NULL,
	CREATE_TIME datetime DEFAULT getdate() NULL,
	USER_IP nvarchar(15)  NULL,
...
CREATE TABLE TSMP_SESS_ATTRS (
	API_SESSION_ID nvarchar(100)  NOT NULL,
	ATTR_NAME nvarchar(20)  NOT NULL,
	ATTR_VALUES nvarchar(4000)  NULL,
	UPDATE_TIME datetime DEFAULT getdate() NULL,
...
CREATE TABLE TSMP_SETTING (
	...
	MEMO NVARCHAR(512)  DEFAULT NULL NULL,
...
CREATE TABLE TSMP_USER (
	...
	ORG_ID varchar(255)  DEFAULT NULL NULL,
	USER_ALIAS NVARCHAR(1000)  DEFAULT NULL NULL,
...
CREATE TABLE TSMP_VGROUP (
	...
	VGROUP_ALIAS nvarchar(255)  NULL,
	VGROUP_DESC NVARCHAR(1500)  NULL,
...
CREATE TABLE ldap_auth_result (
	...
	create_date_time datetime DEFAULT getdate() NULL,
	create_user NVARCHAR(1000)  DEFAULT 'LDAP_SYSTEM' NULL,
	update_date_time datetime NULL,
	update_user NVARCHAR(1000)  NULL,
	version int DEFAULT 1 NULL,
...
CREATE TABLE sso_auth_result (
	...
	code_challenge varchar(50)  NOT NULL,
	create_date_time datetime DEFAULT getdate() NULL,
	create_user NVARCHAR(1000)  DEFAULT 'SSO SYSTEM' NULL,
	update_date_time datetime NULL,
	update_user NVARCHAR(1000)  NULL,
	version int DEFAULT 1 NULL,
	use_date_time datetime NULL,
...
CREATE TABLE TSMPN_NODE_TASK_WORK (
	...
	COMPETITIVE_ID nvarchar(255)  NOT NULL,
	COMPETITIVE_TIME datetime NOT NULL,
	COMPETITIVE_NODE nvarchar(255)  NOT NULL,
	NODE nvarchar(255)  NOT NULL,
	UPDATE_TIME datetime NOT NULL,
	SUCCESS bit NULL,
	ERROR_MSG nvarchar(1023)  NULL,
...
ALTER TABLE TSMP_API_IMP ALTER COLUMN METHOD_OF_JSON NVARCHAR(200) NOT NULL;
...
CREATE TABLE dgr_gtw_idp_auth_code ( 
	...
	user_name 				NVARCHAR(400)	NOT NULL, 				-- 使用者名稱 
	user_alias 				NVARCHAR(400), 							-- 使用者別名 
	user_email 				VARCHAR(500), 							-- 使用者E-Mail 
...
CREATE TABLE dgr_gtw_idp_info_o (
	...
	idp_client_name 		NVARCHAR(200), 							-- IdP用戶端名稱 
	well_known_url 			NVARCHAR(4000), 							-- IdP 的 Well Known URL 
	callback_url 			NVARCHAR(400) 	NOT NULL, 				-- 已授權的重新導向 URI 
	auth_url 				NVARCHAR(4000), 							-- IdP 的 Auth URL 
	access_token_url 		NVARCHAR(4000), 							-- IdP 的 Access Token URL 
	scope 					VARCHAR(4000), 							-- IdP 的 scope
...
ALTER TABLE tsmp_dp_mail_log ADD stack_trace NVARCHAR(4000);
