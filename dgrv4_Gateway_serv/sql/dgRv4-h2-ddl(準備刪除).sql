...
CREATE TABLE TSMP_API_IMP (
	...
	PARAMS_OF_JSON VARCHAR(255),
	HEADERS_OF_JSON VARCHAR(255),
	CONSUMES_OF_JSON VARCHAR(100),
	PRODUCES_OF_JSON VARCHAR(255),
	FLOW VARCHAR,
	CREATE_TIME TIMESTAMP NOT NULL,
...
CREATE TABLE TSMP_VGROUP (
	...
	VGROUP_ALIAS VARCHAR(30),
	VGROUP_DESC VARCHAR(60),
...
ALTER TABLE TSMP_API_IMP ALTER COLUMN METHOD_OF_JSON VARCHAR(200);
