...
public class TsmpnNodeTaskWorkDaoImpl extends BaseDao {
	...
	public List<TsmpnNodeTaskWork> queryTaskStatus(TsmpnNodeTaskWork lastRecord, String[] words, Long nodeTaskId, 
		...
		sb.append("select A from TsmpnNodeTaskWork A where 1 = 1");
		...
		return doQuery(sb.toString(), params, TsmpnNodeTaskWork.class, pageSize);
	}
}
