...
public class TsmpNodeTaskDaoImpl extends BaseDao {
	// add custom methods here
	
	public List<TsmpNodeTask> queryTaskList_1(TsmpNodeTask lastRecord, String[] words, Date startDate, Date endDate, int pageSize) {
		Map<String, Object> params = new HashMap<>();

		StringBuffer sb = new StringBuffer();
		sb.append("select A from TsmpNodeTask A where 1 = 1");
		...
		return doQuery(sb.toString(), params, TsmpNodeTask.class, pageSize);
	}
